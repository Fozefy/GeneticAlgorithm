...
ga.print(pop3)
tournament.selection(selection.size=8, tourn.size = 2, pop = pop3, maximizing = TRUE, verbose = TRUE)
tournament.selection(selection.size=8, tourn.size = 2, pop = pop3, prob.select.worse = 0.2, maximizing = TRUE, verbose = TRUE)
tournament.selection(selection.size=8, tourn.size = 2, pop = pop3, prob.select.worse = 0.2, maximizing = TRUE)
simple.tournament.selection(selection.size=8, tourn.size = 2, pop = pop3, maximizing = TRUE, verbose = TRUE)
simple.tournament.selection(selection.size=8, tourn.size = 2, pop = pop3, maximizing = TRUE)
st.selection <- select.population.fgen(tournament.selection, tourn.size = 2, prob.select.worse = 0.2, maximizing = TRUE)
st.selection(8, pop3)
...
#Test two pops
ga = new.GA.env(GA.base.args=new.GA.base.args(numPop=2, popAdjMatrix=matrix(c(1:100, 1:100), nrow=100, ncol=2)), fitness.args=new.fitness.args(fitness.fn=twoPop.one.max, goal=90))
