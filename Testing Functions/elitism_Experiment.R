...
#boxplot(elite.one.BigGrid,elite.two.BigGrid,elite.three.BigGrid,elite.five.BigGrid,elite.ten.BigGrid,names=c("One","Two","Three","Five","Ten"), main="Elites on Coevo - 8 Grid")
