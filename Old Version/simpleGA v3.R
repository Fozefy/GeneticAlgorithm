...
new.GA.env <- function(GA.base.args = NULL, encoding.args = NULL,  
...
new.encoding.args <- function(pop.size = 100, chr.length = 30, chr.encode.type = "binary", 
											gene.alphabet = NULL, rdist = NULL, rdist.args = NULL, 
											gene.mode = NULL, seq.args = NULL){
	pop.size; chr.length; chr.encode.type; chr.encode.args; gene.alphabet; rdist; rdist.args; gene.mode; seq.args
	as.list(environment())
}
